	...
	<div class="document-totals">
		<table class="invoice-totals">
			...
			<?php if ( 'yes' == get_option( 'woocommerce_calc_taxes' ) ) :
				foreach ( $invoice_details->get_order_taxes() as $code => $tax ) : ?>
					<tr class="invoice-details-vat">
						...
						<td class="right-content column-total"><?php echo $invoice_details->get_order_currency_new( $tax->amount ); ?></td>
					</tr>
				<?php endforeach; ?>
			<?php endif; ?>
			...
			<tr class="invoice-details-total">
				...
				<td class="right-content column-total"><?php echo $invoice_details->get_order_currency_new( $invoice_details->get_order_total() ); ?></td>
			</tr>
		</table>
	</div>
<?php endif; ?>