...
if ( ! class_exists( 'YITH_WooCommerce_Pdf_Invoice_Privacy' ) ) {
    ...
    class YITH_WooCommerce_Pdf_Invoice_Privacy extends YITH_Privacy_Plugin_Abstract
    {
        ...
        public function __construct()
        {
             ...
             */
            parent::__construct( _x( 'YITH Pdf Invoice for WooCommerce premium', 'Privacy Policy Content', 'yith-woocommerce-pdf-invoice' ) );
        ...
        function woocommerce_privacy_export_order_personal_data_props_call_back( $array_meta_to_export )
        {
            ...
            $array_meta_to_export[ '_billing_vat_ssn' ] = __( 'SSN', 'yith-woocommerce-pdf-invoice' );
            $array_meta_to_export[ '_billing_vat_number' ] = __( 'VAT', 'yith-woocommerce-pdf-invoice' );
